...
/*
    ...
    Intuitive:
        Imagine that height map is gradually sinking into a bucket of water
   (level by level). Water fill areas starting from the border. As the water
   level rises, the islands fill up and the water overflows the partitions.
   Water start filling area from the smallest border cell. Facts:
